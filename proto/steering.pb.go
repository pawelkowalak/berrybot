...
type DirectionReply struct {
	Ok bool `protobuf:"varint,1,opt,name=ok" json:"ok,omitempty"`
}

func (m *DirectionReply) Reset()         { *m = DirectionReply{} }
func (m *DirectionReply) String() string { return proto.CompactTextString(m) }
func (*DirectionReply) ProtoMessage()    {}
...
type Driver_DriveClient interface {
	...
	CloseAndRecv() (*DirectionReply, error)
	grpc.ClientStream
}
...
func (x *driverDriveClient) CloseAndRecv() (*DirectionReply, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(DirectionReply)
...
type Driver_DriveServer interface {
	SendAndClose(*DirectionReply) error
...
func (x *driverDriveServer) SendAndClose(m *DirectionReply) error {
